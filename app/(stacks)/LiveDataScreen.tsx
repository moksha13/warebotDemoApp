...
import { SafeAreaView, StyleSheet, Text, StatusBar, View, TouchableOpacity, FlatList } from "react-native";
  ...
  return (
    ...
    <View style={styles.toggleExpansionContainer}>
        <TouchableOpacity onPress={toggleExpansion} style={styles.arrowContainer}>           
          ...
          <Icon name={isExpanded ? 'angle-up' : 'angle-down'} size={20} color="#000" />
          </TouchableOpacity>
          {isExpanded&&
          <View>
          <FlatList
      ...
      renderItem={({ item }) => (
        <View style={styles.itemContainer}>
          ...
          {/* Text */}
          <Text style={{ fontSize:customScale(16)}}>{item.username}</Text>
        </View>
